    ...
    <section id="home" ref={ref} className="relative flex flex-col">
      ...
      <div className="relative w-full h-[125svh] min-h-[880px] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center container mx-auto px-6 lg:px-8 pt-28 md:pt-32">
          <p className="label-caption text-primary-foreground/90 mb-4 text-[10.5px] md:text-[11px]">
            ARCHITECTURE AND DEVELOPMENT
          </p>
          <h1 className="text-primary-foreground max-w-2xl mb-5 text-3xl md:text-4xl lg:text-5xl leading-tight">
            Transforming Land Into Experience‑Led Developments
          </h1>
          <p className="text-primary-foreground/85 max-w-lg mb-7 text-sm md:text-base">
          ...
          <a
            href="#projects"
            className="inline-flex items-center justify-center rounded-full bg-foreground px-8 py-3 text-sm font-medium text-background hover:brightness-110 transition-all"
          >
            Explore Projects
          </a>
        </div>
