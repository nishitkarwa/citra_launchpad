      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {cards.map((c, i) => (
            ...
            >
            <div className="bg-dark text-primary-foreground rounded-2xl p-8 flex flex-col h-full transition-transform duration-500 ease-out hover:-translate-y-8 hover:scale-105 will-change-transform">
