...
export const projects: Project[] = [
  {
    ...
    gallery: [iskconNerellaHero, iskconNerellaMasterplan, iskconNerellaGarden, iskconNerellaAerialView, iskconNerellaPoolView, iskconNerellaFountainView, iskconNerellaGoshalaView, iskconNerellaTowerView, iskconNerella3, iskconNerella4, iskconNerella5],
    featured: true,
  ...
  },
  {
    ...
    cover: westroHero,
    gallery: [westroHero, westro1, westro2, westro3, westro4, westro5],
    featured: true,
  ...
  },
  {
    ...
    gallery: [landscapeVesellaMeadows, landscapeVesellaMeadows2, landscapeVesellaMeadows3, landscapeVesellaMeadows4, landscapeVesellaMeadows5, landscapeVesellaMeadows6],
  },
  {
