...
const postsData: Record<string, { title: string; image: string; date: string; category: string; content: string[] }> = {
  "sustainable-architecture-2025": {
    ...
    content: [
      ...
      "At CITRA, we've embraced this movement from the ground up. Our recent projects incorporate locally sourced materials, energy-efficient building envelopes, and landscape designs that restore native ecosystems. We believe that great architecture doesn't just serve the people inside it — it serves the planet.",
